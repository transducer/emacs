...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(solidity-mode writegood-mode)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Ubuntu Mono" ; Courier Prime, Source Code Pro ExtraLight
                               :size 20
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
